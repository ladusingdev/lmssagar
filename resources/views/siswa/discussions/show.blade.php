...
<div class="card fade-in">
    <div class="card-body">
        <a href="{{ route('siswa.discussions.index') }}" class="btn btn-sm btn-outline-secondary mb-3"><i class="fa-solid fa-arrow-left me-1"></i>Kembali</a>
        ...
        @unless($discussion->is_locked)
            <form method="POST" action="{{ route('siswa.discussions.comments.store', $discussion) }}" class="mt-3">
                @csrf
                <div class="mb-2">
