...
<div class="card fade-in">
    <div class="card-body">
        <a href="{{ route('guru.quizzes.results', $quiz) }}" class="btn btn-sm btn-outline-secondary mb-3"><i class="fa-solid fa-arrow-left me-1"></i>Kembali</a>
        <form method="POST" action="{{ route('guru.quizzes.attempts.review.update', [$quiz, $attempt]) }}">
            @csrf @method('PUT')
