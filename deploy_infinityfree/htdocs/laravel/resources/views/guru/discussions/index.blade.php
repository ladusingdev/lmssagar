...
<div class="card fade-in">
    <div class="card-body">
        <div class="d-flex justify-content-end mb-3">
            <a href="{{ route('guru.discussions.create') }}" class="btn btn-brand btn-sm"><i class="fa-solid fa-plus me-1"></i>Buat Thread</a>
        </div>
                    ...
                    @forelse($discussions as $discussion)
                        <tr>
                            ...
                            <td class="text-end table-actions">
                                <a href="{{ route('guru.discussions.show', $discussion) }}" class="btn btn-sm btn-outline-secondary"><i class="fa-solid fa-eye"></i></a>
                                @if($discussion->user_id === auth()->id())
                                    <form action="{{ route('guru.discussions.destroy', $discussion) }}" method="POST" class="d-inline" data-confirm-delete="Hapus thread ini?">
                                        @csrf @method('DELETE')
