...
class MaterialController extends Controller
{
    ...
    {
        return view('admin.materials.create', ['courses' => $this->courses()]);
    }
    ...
    {
        return view('admin.materials.edit', ['material' => $material, 'courses' => $this->courses()]);
    }
    ...
    {
        return Course::with(['subject', 'classRoom', 'teacher.user'])->get();
    }
}
